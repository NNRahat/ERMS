...
$query=mysqli_query($con,"select EdID from employeedetail where EdID='$empid' and 	EmpPassword='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"update employeedetail set EmpPassword='$newpassword' where EdID='$empid'");
...
<form name="changepassword" class="user" method="post" onsubmit="return checkpass();">
  <?php
$cid=$_SESSION['uid'];
$ret=mysqli_query($con,"select * from employeedetail where EdID='$cid'");
$cnt=1;
