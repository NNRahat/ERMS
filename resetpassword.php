...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con,"update employee set EmpPassword='$password'  where  EmpEmail='$email' && EmpID='$empid' ");
   if($query)
   {
echo ("<script>
    window.alert('Password successfully changed');
    window.location.href='loginerms.php';
    </script>");
session_destroy();
...
<body class="bg-gradient-primary">
  ...
  <div class="container">
    ...
    echo $msg;
                  ...
                  <hr>
               <div class="text-center">
                    <a class="small" href="loginerms.php">Remembered your password? Login!</a>
                  </div>
              </div>
            </div>
          </div>
