...
if(isset($_POST['submit']))
  {
    ...
    Employer2Name,  Employer2Designation, Employer2CTC, Employer2WorkDuration, Employer3Name, Employer3Designation, Employer3CTC,
     Employer3WorkDuration) value('$eid','$emp1name', '$emp1des', '$emp1ctc', '$emp1wd', '$emp2name', '$emp2des', '$emp2ctc', 
     '$emp2wd', '$emp3name', '$emp3des', '$emp3ctc', '$emp3wd' )");
    if ($query) {
...
<p style="font-size:16px; color:red" align="center"> <?php if($msg){
  ...
  <?php
$ExpID=$_SESSION['uid'];
$query=mysqli_query($con,"select * from empexpireince where ExpID=$ExpID");
$row=mysqli_fetch_array($query);
if($row>0)
{
?>
<p style="font-size:16px; color:red" align="center">Go to <b>"Edit my Exp"</b> to edit your experience details. </p>
