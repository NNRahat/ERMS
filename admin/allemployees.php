...
<!-- <form class="user" method="post" action="">
              <div class="row">
                <div class="col-3 mb-2">Search an employee name:</div>
...
<table class="table table-bordered" style="margin-top:2%" id="dataTable" width="100%" cellspacing="0">
...
if(isset($_POST['submit']))
{
  ...
  where employeedetail.EdID = any(select EdID from employeedetail where EmpFname='$sname') ");
  $cnt=1;
