...
if(isset($_POST['submit']))
  {
    ...
    $emp2wd=$_POST['emp2workduration'];
     ...
     $query=mysqli_query($con, "update empexpireince set Employer1Name='$emp1name',  Employer1Designation ='$emp1des', 
     Employer1CTC ='$emp1ctc', Employer1WorkDuration='$emp1wd', Employer2Name='$emp2name',  Employer2Designation ='$emp2des', 
     Employer2CTC ='$emp2ctc', Employer2WorkDuration='$emp2wd'  where ExpID='$eid'");
    if ($query) {
...
<form class="user" method="post" action="">
  <?php
 $ExpID=$_SESSION['uid'];
$ret=mysqli_query($con,"select * from empexpireince where ExpID='$ExpID'");
