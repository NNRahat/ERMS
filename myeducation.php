...
<?php
$EduID=$_SESSION['uid'];
$query=mysqli_query($con,"select * from empeducation where EduID=$EduID");
$row=mysqli_fetch_array($query);
if($row>0)
{
?>
<p style="font-size:16px; color:red" align="center">Go to <b>"edit my Education"</b> to edit your education details</p>
