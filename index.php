    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <!-- Begin Page Content -->
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <div class="d-sm-flex align-items-center justify-content-between mb-4 mx-auto" style="margin-top: 2%">
            <h1 class="h3 mb-0 mx-auto text-gray-800">Employee Record Management System</h1>
          </div>
          ...
          <div class="row d-flex flex-column">
            ...
            <div class="col-xl-5 col-md-6 mb-4 mx-auto">
